 ...
 <div>
   <q-layout view="hHh LpR fFf">
    ...
    <q-header elevated class="bg-primary text-white">
      <q-toolbar>
        ...
        <q-toolbar-title class="flex flex-center">
          <q-avatar class="logo">
              <img src="https://w1.pngwing.com/pngs/770/562/png-transparent-house-logo-clothing-shop-house-music-skirt-shopping-centre-text-line.png" alt="" srcset="">
          </q-avatar>
          Clothing-Shop
        </q-toolbar-title>
      </q-toolbar>
    ...
    <q-drawer show-if-above v-model="left" side="left" elevated>
      ...
      <!--Customer-->
      <q-item clickable v-ripple to="/Check">
        <q-item-section avatar>
